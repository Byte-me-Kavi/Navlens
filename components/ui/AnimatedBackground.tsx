...
export function AnimatedBackground() {
  ...
  useEffect(() => {
    ...
    // Particle system that orbits like planets around sun
    class Particle {
      x: number;
      y: number;
      vx: number;
      ...
      update(
        ...
        const orbitalX =
          this.centerX + Math.cos(currentAngle) * this.orbitRadius;
        const orbitalY =
          this.centerY + Math.sin(currentAngle) * this.orbitRadius;
        ...
        if (mouseActive) {
          ...
          if (distance < 600) {
            ...
            this.disruptionStrength = Math.min(
              1,
              this.disruptionStrength + 0.15
            );
          }
        }
