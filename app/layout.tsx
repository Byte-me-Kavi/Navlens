    ...
    <html lang="en">
      <body className="antialiased" suppressHydrationWarning>
        ...
        */}
        <script
          async
          src="http://navlens-git-v2-dom-recreation-kavishas-projects-947ef8e4.vercel.app/tracker.js"
          data-site-id="a2a95f61-1024-40f8-af7e-4c4df2fcbd01"
          data-api-key="69e4dce7-5f3b-44c9-a0e1-aea13097e8a1"
          data-api-host="http://navlens-git-v2-dom-recreation-kavishas-projects-947ef8e4.vercel.app"
        ></script>
        <script
          async
