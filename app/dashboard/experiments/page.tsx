...
export default function ExperimentsPage() {
  return (
    <div className="space-y-6">
      ...
      {/* Coming Soon Card */}
      <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-12 text-center shadow-sm">
        <div className="flex justify-center mb-6">
          <div className="relative">
            <div className="p-6 bg-white rounded-full shadow-md">
              <BeakerIcon className="w-16 h-16 text-blue-600" />
            </div>
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-8 text-left">
          <div className="bg-white rounded-lg p-4 border border-blue-200 shadow-sm">
            ...
            <h4 className="font-bold text-gray-900 mb-1">AI Recommendations</h4>
          ...
          <div className="bg-white rounded-lg p-4 border border-blue-200 shadow-sm">
            ...
            <h4 className="font-bold text-gray-900 mb-1">A/B Testing</h4>
            <p className="text-sm text-gray-600">
          ...
          <div className="bg-white rounded-lg p-4 border border-blue-200 shadow-sm">
            ...
            <h4 className="font-bold text-gray-900 mb-1">Auto-Optimization</h4>
            <p className="text-sm text-gray-600">
